#' @importFrom stats poisson pnbinom ppois predict qnorm runif simulate
...
#' @param type Which plot to draw. Values: *all* (default); *envelope* for envelopes of randomized quantile residuals;
#' @param ... Ignore
#' *dispersion* for plot to assess the dispersion; *zeros* for plot to assess the zero inflation.
#' @return A vector with the variance components and related parameters
#' @method plot GOF
#' @export
#' @examples
